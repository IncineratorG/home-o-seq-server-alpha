package com.touristskaya.homeoseq.common.actions.actions_buffer;
...
public class ActionsBuffer implements EventsSource {
    ...
    private ActionTypes mServiceActions;
    ...
    public ActionsBuffer(EventsSource eventsSource, String newActionEventType, ActionTypes serviceActions) {
