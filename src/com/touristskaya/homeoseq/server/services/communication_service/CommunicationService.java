...
public class CommunicationService extends NewService {
    ...
    public CommunicationService(ServerActionsDispatcher dispatcher) {
        mActionsDispatcher = dispatcher;
        mServiceDescription = new CommunicationServiceDescription();
        mActionsHandler = (action -> {});
    ...
    protected void cleanup() {
        SystemEventsHandler.onInfo("CommunicationService->stop()");
...
//import com.touristskaya.homeoseq.server.services.communication_service.common.communication_bridge.firebase_communication_bridge.FirebaseCommunicationBridge;
//import com.touristskaya.homeoseq.server.services.communication_service.common.communication_manager.CommunicationManager;
//import com.touristskaya.homeoseq.server.services.communication_service.common.communication_manager.firebase_communication_manager.FirebaseCommunicationManager;//import com.touristskaya.homeoseq.server.services.communication_service.service_description.CommunicationServiceDescription;
//
//import java.util.concurrent.LinkedBlockingQueue;
//
