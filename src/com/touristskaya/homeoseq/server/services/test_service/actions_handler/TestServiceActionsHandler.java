...
public class TestServiceActionsHandler implements ActionsHandler {
    ...
    public void onAction(Action action) {
        if (action.type().equals(mTestServiceDescription.actionTypes.MAKE_TEST_TASK)) {
//            SystemEventsHandler.onInfo("PROCESSOR_THREAD: " + Thread.currentThread().getId());
//            action.complete(mTestServiceDescription.actionResults.makeTestActionResult("RESULT_STRING"));
